...
public class ConstructTree {
    ...
    public static BinarySearchTree<Integer> SortedArray(int arr[],int n){
        return SortedArray(arr, 0, n-1);
    }
    public static BinarySearchTree<Integer> SortedArray(int arr[],int startIndex,int endIndex){
        if (startIndex > endIndex) {
            return null;
        }
        int mid = (startIndex + endIndex)/2;
        BinarySearchTree<Integer> root = new BinarySearchTree<>(arr[mid]);
    ...
    public static void preOrder(BinarySearchTree<Integer> root){
        if(root==null){
            return;
        }
